  ...
  const plans = [
    {
      ...
      price: "$2.99",
      period: tc("perMonth"),
      tokens: tl("basicTokens"),
      highlight: false,
      badge: null as string | null,
      features: [tl("basicFeature1"), tl("basicFeature2"), tl("basicFeature3"), tl("basicFeature4"), tl("basicFeature5")],
    },
    {
      id: "pro",
      name: tl("proPlan"),
      ...
      features: [tl("proFeature1"), tl("proFeature2"), tl("proFeature3"), tl("proFeature4"), tl("proFeature5"), tl("proFeature6")],
    },
    {
      id: "business",
      name: tl("businessPlan"),
      price: "$19.99",
      period: tc("perMonth"),
      tokens: tl("businessTokens"),
      highlight: false,
      badge: null as string | null,
      features: [tl("businessFeature1"), tl("businessFeature2"), tl("businessFeature3"), tl("businessFeature4"), tl("businessFeature5"), tl("businessFeature6")],
    },
  ];

  const packs = [
    { id: "tokens_10", label: tl("starterPack") + " Pack", tokens: 10, price: "$2.99", highlight: false, badge: null as string | null },
    { id: "tokens_25", label: tl("valuePack") + " Pack", tokens: 25, price: "$5.99", highlight: true, badge: tl("bestValue") },
    { id: "tokens_50", label: tl("proPack") + " Pack", tokens: 50, price: "$9.99", highlight: false, badge: null as string | null },
  ];

  const packFeatures = [t("tokensNeverExpire"), t("allDocTypes"), t("instantPdf"), t("logoOnDocs"), t("noSubscription")];
    ...
    <div className="space-y-8">
        ...
        <div className="inline-flex rounded-xl border border-gray-200 bg-gray-50 p-1">
          <button
            ...
            className={`rounded-lg px-5 py-2 text-sm font-medium transition-colors ${
              tab === "packs" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700"
            }`}
          >
      ...
      {tab === "packs" && (
        <div className="space-y-6">
          <p className="text-center text-sm text-gray-500">{t("packsDesc")}</p>
          <div className="grid gap-6 sm:grid-cols-3">
            {packs.map((pack) => (
              <div
                key={pack.id}
                className={`relative rounded-xl border-2 bg-white p-6 shadow-sm ${
                  pack.highlight ? "border-indigo-500 shadow-indigo-100 shadow-md" : "border-gray-200"
                }`}
              >
                {pack.badge && (
      ...
      <Card className="bg-indigo-50 border-indigo-200">
        <CardContent className="py-5 text-center">
          <p className="text-sm text-indigo-700">{t("guarantee")}</p>
        </CardContent>
      </Card>
    </div>
  );
